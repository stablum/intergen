...
fn format_utc_timestamp(timestamp: Duration) -> String {
...
mod tests {
    ...
    use super::{format_utc_timestamp, manual_screenshot_filename, parse_launch_config};
    ...
    #[test]
    fn manual_screenshot_filename_uses_readable_timestamp_and_sequence() {
        let filename = manual_screenshot_filename(Duration::new(1_741_018_296, 45_000_000), 7);

        assert_eq!(filename, "intergen-2025-03-03_16-11-36-045-0007.png");
    }
}
