...
const TOP_LEVEL_HELP: [HelpEntry; 5] = [
    ...
    HelpEntry {
        startup: "F2 cycles groups/compact/list/close for the live control page",
        overlay: "F2: Open parameter groups, second press opens compact controls, third press opens the full list, fourth press closes",
        binding: "F2",
        explanation: "Open parameter groups, second press opens compact controls, third press opens the full list, fourth press closes.",
    },
    HelpEntry {
...
const FX_HELP: [HelpEntry; 14] = [
    ...
    HelpEntry {
        startup: "second F2 press opens compact, third opens the full parameter list",
        overlay: "In F2 page: Second F2 press opens compact controls, third press opens the full list",
        binding: "F2",
        explanation: "In the F2 page, a second press opens compact controls and a third press opens the full parameter list.",
    },
    HelpEntry {
        startup: "Left/Right or Tab/Shift+Tab switch the active field",
        overlay: "In F2 compact or list page: Left / Right or Tab / Shift+Tab switch the active field",
    ...
    HelpEntry {
        ...
        overlay: "In F2 compact or list page: L toggles the selected parameter LFO when supported",
        binding: "L",
        explanation: "In the F2 compact or list page, toggle the selected parameter LFO when supported.",
    },
    HelpEntry {
        startup: "typing a number sets the active numeric field",
        overlay: "In F2 compact or list page: Type digits / . / , / - / + (for example 0.157) to set the active numeric field",
        binding: "Digits / . / , / - / +",
        explanation: "In the F2 compact or list page, set the active numeric field directly.",
    },
    HelpEntry {
        startup: "Backspace erases typed F2 input",
        overlay: "In F2 compact or list page: Backspace erases the typed numeric input",
        binding: "Backspace",
        explanation: "In the F2 compact or list page, erase the typed numeric input.",
    },
    HelpEntry {
        startup: "Shift is coarse",
        overlay: "Shift: Coarse F2 adjustment",
        binding: "Shift",
        explanation: "In the F2 compact or list page, use coarse adjustment.",
    },
    HelpEntry {
        startup: "Alt is fine",
    ...
    HelpEntry {
        ...
        overlay: "In F2 compact or list page: Enter confirms typed input, or resets the selected field when no numeric input is active",
        binding: "Enter",
        explanation: "In the F2 compact or list page, confirm typed numeric input, or reset the selected field when no numeric input is active.",
    },
    HelpEntry {
